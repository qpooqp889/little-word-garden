...
- [ ] 新增 Body Parts 與 Clothes 分類
- [ ] 擴充兩個分類的單字、中文、圖片 fallback 與雙語發音欄位
- [ ] 生成兩個新分類的代表性圖片資產
- [ ] 加入首次載入吉祥物動畫與 reduced-motion 處理
- [ ] 建立家長專區，顯示星星、答題進度與分類探索狀況
- [ ] 驗證新分類、發音、載入畫面與家長專區手機版
- [ ] 同步 GitHub Pages 並保存交付版本
